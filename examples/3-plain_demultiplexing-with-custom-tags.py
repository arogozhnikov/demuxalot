"""
Simple demultiplexing with known genotypes using custom SAM tags
"""
...
barcode_handler = BarcodeHandler.from_file('./example_data/test_barcodes.csv', tag=custom_celltag)
print(f'Loaded barcodes: {barcode_handler}')

parse_read_custom = lambda read: parse_read(read, umi_tag = custom_umitag)
snps = count_snps(
